...
urlpatterns = [
    ...
    path('influencer/application/', views.influencer_application, name='influencer_application'),
    path('influencer/application/success/', views.influencer_application_success, name='influencer_application_success'),
...
path('order-tracking/', views.order_tracking, name='order_tracking'),
 # Video management URLs
    ...
    # Earnings and withdrawal URLs
    path('influencer/earnings/', views.influencer_earnings, name='influencer_earnings'),
    path('influencer/request-withdrawal/', views.request_withdrawal, name='request_withdrawal'),
    path('admin/influencers/', views.manage_influencers, name='manage_influencers'),
    path('admin/influencer/<int:user_id>/toggle-status/', views.toggle_influencer_status, name='toggle_influencer_status'),
    path('admin/influencer/<int:user_id>/', views.view_influencer_details, name='view_influencer_details'),
    path('admin/influencer/<int:user_id>/delete/', views.delete_influencer, name='delete_influencer'),
    ...
    # Link clicked from email → reset form
